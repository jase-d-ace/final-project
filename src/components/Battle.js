...
class Battle extends Component {
  ...
  getRandomPoke(){
    ...
    axios.get('https://pokeapi.co/api/v2/pokemon/'+randomPoke).then((response) =>{
  ...
  caught(){
    ...
    axios.post('https://safari-zone.herokuapp.com/api', {
    ...
    axios.put('https://safari-zone.herokuapp.com/users/'+this.state.trainer_id,{
      cash: (-1000),
      pokeballs: 0,
      ultraballs: 0,
      greatballs: 0,
