...
user.update = (pokeballs, greatballs, ultraballs, cash, id) =>{
  return db.one('UPDATE users SET pokeballs = pokeballs + $1, greatballs = greatballs + $2, ultraballs = ultraballs + $3, cash = cash - $4 WHERE id = $5 returning *', [pokeballs, greatballs, ultraballs, cash, id])
}
module.exports = user;
